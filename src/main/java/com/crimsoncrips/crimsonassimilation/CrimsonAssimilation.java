package com.crimsoncrips.crimsonassimilation;
...
@Mod(CrimsonAssimilation.MODID)
public class CrimsonAssimilation {




    // Define mod id in a common place for everything to reference
    public static final String MODID = "crimsonassimilation";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();


    public CrimsonAssimilation() {
